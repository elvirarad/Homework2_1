...
public class Main {
    public static void main(String[] args) {
        ...
        transport[3] = new Transport("Kia", "Sportage 4-го поколения", "Южная Корея", 2.4F, 2018,"красный", "5АКПП", "кроссовер", "т159ип116", 5, false);
        transport[4] = new Transport("Hyundai", "Avante", "Южная Корея", 01.6F, 2016, "оранжевый", "4АКПП", "пикап", "м777мм177", 4,false);
